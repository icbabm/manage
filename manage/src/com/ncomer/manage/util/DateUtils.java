package com.ncomer.manage.util;
 ...
 * @Author: Yu.Gang
 * @Description:
 * @Data: Created in 9:39 2018/5/10
 * @ModifiedBy:
 */
public class DateUtils {
    ...
    public static String getBeforeDatePlusDay(int numVal, String dateFormat) {
        ...
        Long dateMillis = DateUtils.stringToDate(dateFormat,DateUtils.DATE_NORMAL_FORMAT).getTime();

        long hourInMillis = 60 * 60 * 1000;
        long dVal = numVal * 24 * hourInMillis;

        SimpleDateFormat sdf = new SimpleDateFormat(DateUtils.DATE_NORMAL_FORMAT);
        String currentDate = sdf.format(dateMillis - dVal);
        return currentDate;
    }
     ...
     * 2018-08-23
     */
    public static Date getAfterDaysDate(Date date,int numVal) {
        long hourInMillis = 60 * 60 * 1000;
        long dVal = numVal * 24 * hourInMillis;
        return new Date(date.getTime() + dVal);
    }
